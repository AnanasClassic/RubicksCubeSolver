...
std::string CubePosition::rotateUp(CubePosition& pos) {
...
std::string CubePosition::rotateFront(CubePosition& pos) {
...
std::string CubePosition::rotateRight(CubePosition& pos) {
...
std::string CubePosition::rotateBack(CubePosition& pos) {
...
std::string CubePosition::rotateLeft(CubePosition& pos) {
...
std::string CubePosition::rotateDown(CubePosition& pos) {
...
std::string CubePosition::counterRotateUp(CubePosition& pos) {
...
std::string CubePosition::counterRotateFront(CubePosition& pos) {
...
std::string CubePosition::counterRotateRight(CubePosition& pos) {
...
std::string CubePosition::counterRotateBack(CubePosition& pos) {
...
std::string CubePosition::counterRotateLeft(CubePosition& pos) {
...
std::string CubePosition::counterRotateDown(CubePosition& pos) {
